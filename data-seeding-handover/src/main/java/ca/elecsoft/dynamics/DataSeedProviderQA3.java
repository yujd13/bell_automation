...
public class DataSeedProviderQA3 {
    public static WebDriver driver;
//    private static final Logger logger = LogManager.getLogger(DataSeedProviderQA3.class);
...
//
        ...
        try {
            ...
            newLeadPage.selectInquiryType(2);
...
//            orderInformation.openNextStageMen();
            ...
            Thread.sleep(2000);
//            bufferedImageList.add(word.takeBrowerSinglePhone(driver));
