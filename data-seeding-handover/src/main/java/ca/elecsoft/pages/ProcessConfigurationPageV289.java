...
public class ProcessConfigurationPageV289 {
    private WebDriverWait wait;
    private WebDriver driver;
    public static final String BLANK = "";


    public ProcessConfigurationPageV289(WebDriverWait wait, WebDriver driver, String url) throws InterruptedException {
        this.wait = wait;
        this.driver = driver;
        driver.get(url);
        Thread.sleep(5000);
