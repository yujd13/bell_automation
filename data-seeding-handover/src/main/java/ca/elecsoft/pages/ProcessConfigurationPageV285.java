...
public class ProcessConfigurationPageV285 {
    private WebDriverWait wait;
    private WebDriver driver;

    public ProcessConfigurationPageV285(WebDriverWait wait, WebDriver driver, String url) throws InterruptedException {
        this.wait = wait;
        this.driver = driver;
        driver.get(url);
        Thread.sleep(5000);
...
//        By xpath = By.xpath("//*[@id=\"id-02676df4-7d36-4846-9174-c267720d898b-12-cgi_ccetemplateopportunity6-cgi_ccetemplateopportunity.fieldControl-option-set-select\"]");
    ...
    public String getNEW_PANEL_ID___PHONE___OPPORTUNITY() {
        return getBasicField("cgi_new_panel");
...
//        return noIdLabels(xpath);
    ...
    public String getCOPY_SBN_INFORMATION_OPPORTUNITY() {
        return getBasicField("cgi_copyservicelocationsbndetails");
    }

    public String getDETAIL_SECTION_VISIBLE_OPPORTUNITY() {
        return getDetail_section_visible();
    }
    ...
    public String getSEND_LINE_TYPE__INCL_CHOICE_INTEGRATION_CAL() {
        return getBasicField("cgi_sendlinetypeincludedchoice_cad");
    }
    ...
    public String getFULL_UPGRADE_INTEGRATION_CAL() {
        String a = getBasicField("cgi_fullupgrade").trim();
