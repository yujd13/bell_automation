...
public class ReadAccountEntityVersionE {
    ...
    public static void insertDatabaseSQLProdCadE(File f) throws IOException, InvalidFormatException, SQLException {
        ...
        if (N > 0) {
            for (int i = 0; i <= N; i++) {
                ...
                util.storeListProdCadE(input, util.buildProdCad(input, new ProdCadEVersionE()));
//                db.insertAccount(sql);
    ...
    /**
     * @param f - the actual product catalogue file
     * @throws IOException
     * @throws InvalidFormatException
     * @throws SQLException
     *
     * this method is for inserting into the database the actual product catalogue file
     *
     */
...
//                util.storeList(input);
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException, SQLException {
        ...
        System.out.println(HibernateUtilVersionE.getINSTANCE().getOneProdCadA("WS7"));
//        System.out.println(createJavaModel());
//        testModel();
