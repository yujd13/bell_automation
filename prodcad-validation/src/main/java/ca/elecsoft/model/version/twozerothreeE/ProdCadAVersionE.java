package ca.elecsoft.model.version.twozerothreeE;
...
/**
 * This class is represents the product model of the actual file
 */
@Entity
public class ProdCadAVersionE implements Serializable {
    @Id
